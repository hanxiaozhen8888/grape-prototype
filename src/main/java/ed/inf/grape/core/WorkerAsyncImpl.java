...
//
//	private static final long serialVersionUID = -3644084806763521592L;
//
...
//	private BlockingQueue<LocalComputeTask> localComputeTaskQueue;
//
//	/** hosting partitions */
...
//
//	/** PartitionID to Incoming messages */
//	private ConcurrentHashMap<Integer, List<Message>> incomingMessages;
//
//	/**
...
//		this.localComputeTaskQueue = new LinkedBlockingDeque<LocalComputeTask>();
//		this.incomingMessages = new ConcurrentHashMap<Integer, List<Message>>();
...
//					try {
//
//						LocalComputeTask localComputeTask = localComputeTaskQueue
//								.take();
//
...
//								List<Message> messageForWorkingPartition = incomingMessages
//										.get(localComputeTask.getPartitionID());
//
...
//						}
//
//						localComputeTasksQueue.add(localComputeTask);
//						checkAndSendMessage();
//
//					} catch (Exception e) {
//						e.printStackTrace();
